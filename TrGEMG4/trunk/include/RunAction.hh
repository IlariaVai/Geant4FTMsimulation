...
class G4Run;
class GasDetectorConstruction;
class ParallelPrimaryGeneratorActionScan;
class HistoManager;
...
{
  public:
    RunAction(GasDetectorConstruction*, ParallelPrimaryGeneratorActionScan*);
   ~RunAction();
  ...
  private:
    GasDetectorConstruction*   fDetector;
    ParallelPrimaryGeneratorActionScan* fPrimary;
